...
import 'package:flutter_e_ticaret/components/view/basket/card_back.dart';
import 'package:flutter_e_ticaret/components/view/basket/card_front.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //                      ),
                        ...
                        SizedBox(height: 27,),
                        MyButton(onTap: () {}, message: "Onayla ve Bitir")
                      ],
                    ),
                  ),
                ),
